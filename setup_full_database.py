...
async def setup_database():
    ...
    async with AsyncSessionLocal() as session:
        ...
        ('130Р', 'Москва', 'Ростов-на-Дону', 5, 19, 14, 2900),
        ('132Р', 'Ростов-на-Дону', 'Москва', 6, 20, 14, 2800),
        
        # Москва - Краснодар
        ('140К', 'Москва', 'Краснодар', 7, 25, 18, 3500),
        ('142К', 'Краснодар', 'Москва', 8, 26, 18, 3400),
        
        # Москва - Мурманск
        ('150М', 'Москва', 'Мурманск', 9, 42, 33, 5000),
        ('152М', 'Мурманск', 'Москва', 10, 43, 33, 4900),
        
        # Москва - Челябинск
        ('160Ч', 'Москва', 'Челябинск', 6, 30, 24, 3800),
        ('162Ч', 'Челябинск', 'Москва', 7, 31, 24, 3700),
        
        # Санкт-Петербург - Сочи
        ('170П', 'Санкт-Петербург', 'Сочи', 10, 48, 38, 6200),
        ('172П', 'Сочи', 'Санкт-Петербург', 11, 49, 38, 6100),
        
        # Казань - Новосибирск
        ('180К', 'Казань', 'Новосибирск', 8, 52, 44, 5500),
        ('182К', 'Новосибирск', 'Казань', 9, 53, 44, 5400),
        
        # Москва - Пермь
        ('190П', 'Москва', 'Пермь', 7, 28, 21, 3600),
        ('192П', 'Пермь', 'Москва', 8, 29, 21, 3500),
        
        # Москва - Архангельск
        ('200А', 'Москва', 'Архангельск', 6, 26, 20, 3400),
        ('202А', 'Архангельск', 'Москва', 7, 27, 20, 3300),
        
        # Санкт-Петербург - Новосибирск
        ('210С', 'Санкт-Петербург', 'Новосибирск', 10, 66, 56, 7000),
        ('212С', 'Новосибирск', 'Санкт-Петербург', 11, 67, 56, 6900),
        
        # Москва - Омск
        ('220О', 'Москва', 'Омск', 8, 46, 38, 5200),
        ('222О', 'Омск', 'Москва', 9, 47, 38, 5100),
        
        # Екатеринбург - Новосибирск
        ('230Е', 'Екатеринбург', 'Новосибирск', 6, 26, 20, 3800),
        ('232Е', 'Новосибирск', 'Екатеринбург', 7, 27, 20, 3700),
        ]
